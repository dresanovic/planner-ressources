  ...
  return (
    <div className="dialog-backdrop">
      <div ref={dialogRef} className="replacement-dialog discard-changes-dialog" role="dialog" aria-modal="true" aria-labelledby="discard-changes-title" aria-describedby="discard-changes-description">
        ...
        <p id="discard-changes-description">Your session changes have not been saved. Discard them to continue to {destinationLabel}.</p>
        <div className="dialog-actions">
          <button ref={keepRef} type="button" className="secondary-button" onClick={keep}>Keep editing</button>
          <button type="button" className="destructive-button" onClick={discard}>Discard changes</button>
        </div>
      </div>
    </div>
  )
