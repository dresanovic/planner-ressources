...
it('shows coded searchable candidates, preserved invalid relationships, and fixed preferences', async () => {
  ...
  expect(document.body.textContent).toContain('Kapazität 20 · benötigt 30')
  expect(document.body.textContent).toContain('Wechsel von Lehrpersonen')
  expect(document.body.textContent).toContain('Montag · 09:00–11:00')
  expect(document.body.textContent).toContain('2 gespeicherte Termine in 1 Planungen')
  expect(document.body.textContent).not.toContain('ROOM_CAPACITY_INSUFFICIENT')
