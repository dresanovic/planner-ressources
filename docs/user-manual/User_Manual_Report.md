...
The user manual was updated on 11.08.2026 to reflect the current verified Resource Planner, including the implemented portions of FS-022 and the accountless lecturer-review workflow now present in the application.
...
| `npm run test` in `client` | Passed: 55 files, 371 tests |
...
- Local PowerShell startup remains documented because no production end-user URL or deployment runbook is supplied.
